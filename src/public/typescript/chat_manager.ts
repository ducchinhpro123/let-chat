import FriendSearch from 'public/typescript/friend_search';
import App from 'public/typescript/main';
...
class ChatManager {
    ...
    constructor() {
        ...
        this.chatMessages = document.querySelector('.chat-messages') as HTMLElement | null;
        this.chatHeader = document.querySelector('.chat-header') as HTMLElement | null;
        this.chatInput = document.querySelector('.chat-input') as HTMLElement | null;
        this.sendBtn = document.querySelector('.send-button') as HTMLElement | null;
        this.typingIndicator = document.querySelector('.typing-indicator') as HTMLElement | null;
        this.typingText = document.querySelector('.typing-text') as HTMLElement | null;
        this.messageInput = null;
        this.editor = null;
        this.handleSendMessage = this.handleSendMessage.bind(this);
        this.username = (document.querySelector('#username-hidden') as HTMLInputElement).value;
    ...
    setupEventListeners() {
        ...
        // Enter press
        const editorElement = this.chatArea?.querySelector('.hr-editor') as HTMLElement | null;
    ...
    removeNodeMessage(messageId: string) {
        const selectedMsg = this.chatMessages?.querySelector(`[data-id="${messageId}"]`) as HTMLElement;
    ...
    handleContextMenuAction(action: string | undefined, messageId: string, conversationId: string) {
        ...
        switch (action) {
            case 'delete':
                this.socketManager.emit('delete message', {messageId, conversationId}, (response: any) => {
    ...
    handleSendMessage() {
        ...
        if (this.socketManager) {
            this.socketManager.emit('I just sent a new message', data, (response: any) => {
