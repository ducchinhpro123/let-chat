...
class FriendSearch {
    ...
    `;
        ...
        if (isYourFriend) {
            ...
            if (inviteFBtn) {
                ...
                inviteFBtn.addEventListener('click', () => this.handlAddFriendToConversation(user._id.toString(), conversationId));
            }
        } else {
            const inviteFBtn = friendItem.querySelector('.invite-friend-btn');
            if (inviteFBtn) {
                inviteFBtn.addEventListener('click', () => this.handleInvite(user._id.toString()));
            }
        }
    ...
    handlAddFriendToConversation(userId: string, conversationId: string | undefined) {
